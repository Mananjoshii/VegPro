...
/**
 * Staff Management page — list, add, edit, delete staff members.
 */
export default function StaffManagement() {
  ...
  const handleDelete = async (id, name) => {
    if (!window.confirm(`Delete ${name}? This will also delete their attendance records.`)) {
      return;
    }
      ...
      <div className="space-y-4">
        ...
        {staff.length === 0 ? (
          <Card className="text-center py-10">
            <p className="text-gray-400 text-lg mb-4">No staff added yet</p>
            <Button onClick={handleAdd}>Add First Staff Member</Button>
          </Card>
        ) : (
